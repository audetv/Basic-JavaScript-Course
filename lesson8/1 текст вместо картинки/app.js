...
let buttons = document.querySelectorAll('.products .product button');
...
function showMoreText(card) {
    ...
    const text = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium, doloremque.'
    document.querySelector('body > p').innerText = text + ' ' + card.productName.innerText;
